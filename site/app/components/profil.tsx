      ...
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        >
          <p className="font-poppins text-gray-600 text-lg leading-relaxed">
            Je m’appelle Franck. J’ai construit ma méthode sur le terrain, au contact de centaines de milliers de personnes que j’ai accompagnées dans la diminution et l’arrêt du tabac  des profils variés, des histoires uniques, des défis que les programmes standards ne savent pas traiter.
          </p>
          <p className="font-poppins text-gray-600 text-lg leading-relaxed">
